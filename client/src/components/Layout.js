        ...
        <div className='d-flex layout'>
           <div className='sidebar'>
            <div className='sidebar-header'>
                <div className='d-flex '><h1 className='logo'>+MediCare</h1>
                {!collapsed && <img className="photo p-2 " src='https://www.creativefabrica.com/wp-content/uploads/2020/02/11/Medical-Logo-Graphics-1-51-580x386.jpg'/>}</div>
           ...
           <div className='content'>
            ...
            <Link to='/' className='anchor-n mx-3'>{user?.name}</Link>
